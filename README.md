# Kaplansky Idempotent Conjecture — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/kaplansky-idempotent-conjecture-canonical-lane-mathlib.git
cd kaplansky-idempotent-conjecture-canonical-lane-mathlib
lake exe
lake build
```
