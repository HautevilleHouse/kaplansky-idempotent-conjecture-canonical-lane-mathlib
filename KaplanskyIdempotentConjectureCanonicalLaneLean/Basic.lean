/-!
# kaplansky-idempotent-conjecture-canonical-lane Lean migration boundary
...
`KaplanskyIdempotentConjectureCanonicalLaneLean/SourcePackage.lean`.
...
def sourceRepository : String := "kaplansky-idempotent-conjecture-canonical-lane"
def sourceUrl : String := "https://github.com/HautevilleHouse/kaplansky-idempotent-conjecture-canonical-lane"
def sourceDescription : String := "Canonical-lane closure package for Kaplansky idempotent conjecture: admissible-class formulation, projection gates, local-to-global bridge, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["kaplansky-idempotent-conjecture", "group-rings", "algebra", "geometric-group-theory", "operator-algebra", "mathematical-proof", "reproducibility", "canonical-lane", "local-to-global", "manifold-constrained"]
